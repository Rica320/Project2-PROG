...
ADDITIONAL SPECIFICATIONS:
  ...
  Partiu-se do pressuposto, quanto ao ficheiro de vencedores, que este poderia ainda não existir ou então estar vazio, sendo assim 
  ...
  sendo válidos), não ter que criar um ficheiro para os vencedores. Além disso, só é possível mostrar os (eventuais) vencedores 
  de um dado maze na condição de esse maze existir.
  
  Por outro lado, também se assumiu que os labirintos (mazes) apenas contêm saídas (O) na sua delimitação ou periferia. Nenhuma 
  indicação foi dada para o que acontecia para o caso de tal não acontecer, e tendo em conta que os robôs não tem visão, estes poderiam 
  muito bem ir ao encontro destes portais de saída. 
  ...
  Finalmente, partiu-se do princípio que poderiam existir inicialmente no maze robôs mortos/presos (r).
